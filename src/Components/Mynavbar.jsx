...
function MyNavbar() {
  ...
  const getJobs = async () => {
    ...
    try {
      ...
      if (searchTerm.toLowerCase().includes("allevatori")) {
        ...
        navigate(`/results?company=${searchTerm}`, {
          state: { jobs: [fakeJob] },
        });
        return;
      }
  ...
  return (
    <Navbar
      expand="lg"
      className="bg-white border-bottom border-secondary py-0"
    >
      <Container fluid>
        <Row className="d-flex w-100">
          ...
          <Col
            md={4}
            className="d-flex align-items-center mt-1 ms-0 ms-lg-5 mt-2 justify-content-between"
          >
            {/* Logo */}
            ...
            <div className="d-flex align-items-center ">
              <Navbar.Brand
                as={Link}
                to="/"
                className="text-primary fs-1 ms-2 ms-lg-5 me-1 pt-0 mt-2"
              >
                <FaLinkedin size={55} />
              </Navbar.Brand>
            ...
            {showMobileSearch ? (
              ...
              <div className="d-flex align-items-center justify-content-end flex-grow-1 gap-3 d-lg-none me-2">
                ...
                >
                  ...
                  <span className="d-none d-lg-block text-secondary">
                    Messaggistica
                  </span>
                </Nav.Link>
                  ...
                  {showDropdown && (
                    ...
                    >
                      <div className="d-flex align-items-center mb-3">
                        ...
                        />
                        <div>
                          <div className="fw-bold ps-2 pt-3">
          ...
          <Col md={5} className="d-none d-lg-block ms-lg-5 ps-lg-5 fs-6">
            <Nav
              className="d-flex justify-content-between justify-content-lg-start align-items-center gap-lg-4 ps-2 ps-lg-3 mt-3 py-0"
              navbarScroll
            >
              <Nav.Link
                as={Link}
  ...
  <span className="d-none d-lg-block text-secondary">Lavoro</span>
              ...
              <NavItem
                icon={<FaBell size={30} className="glow-icon" />}
                label="Notifiche"
              />
              ...
              <div ref={dropdownRef} className="position-relative">
                ...
                {showDropdown && (
                  ...
                  >
                    ...
                    <a href="#privacy" className="dropdown-item px-0">
                      Impostazioni e privacy
                    </a>
                    <a href="#guida" className="dropdown-item px-0">
                      Guida
                    </a>
                    <a href="#lingua" className="dropdown-item px-0 mb-2">
                      Lingua
                    </a>
                    <hr className="my-2" />
                    <div className="mb-2 text-muted fw-semibold">Gestisci</div>
                    <a href="#attivita" className="dropdown-item px-0">
                      Post e attività
                    </a>
                    <a href="#offerte" className="dropdown-item px-0 mb-2">
                      Account per pubblicare offerte
                    </a>
                    <hr className="my-2" />
                    <a href="#logout" className="dropdown-item px-0 text-muted">
                      Esci
                    </a>
                  </div>
                )}
          ...
          <Col
            md={2}
            className="d-none d-xxl-flex text-secondary mt-2 border-start border-secondary ps-2 g-4"
            ref={businessRef}
          >
            <div
            ...
            <div>
              ...
              >
                ...
                (Non è assolutamente un modo <br /> per inviare un bonifico a
                Luca)
              </a>
            </div>
          </Col>
